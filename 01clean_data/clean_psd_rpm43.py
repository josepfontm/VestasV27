...
#Save results
psd_rpm43.to_csv('../code_methodology/01clean_data/results/psd_rpm43.csv',sep=';')
metadata_rpm43.to_csv('../code_methodology/01clean_data/results/metadata_rpm43.csv',sep=';')
...
plt.figure()
plt.semilogy(psd_rpm43.T,color='blue',linewidth = 1)
plt.show()
