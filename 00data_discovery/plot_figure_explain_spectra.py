...
for i in range(np.shape(psd)[0]):
    if rpm[i] > 32.5 and rpm[i] < 42.5: #T2 
        color_line = 'gainsboro' #003f5c
        plt.loglog(np.linspace(0,64,np.shape(psd)[1]),psd[i,:],color = color_line ,linewidth=0.01)
        ...
        plt.loglog(np.linspace(0,64,np.shape(psd)[1]),psd[i,:],color = color_line ,linewidth=0.01)
    elif rpm[i] <= 0.5 and pitch[i] < 60: #Idle
...
plt.loglog([0.716666,0.716666],[100,10e-10], color='black')

plt.loglog([2*0.716666,2*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([3*0.716666,3*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([4*0.716666,4*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([5*0.716666,5*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([6*0.716666,6*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([7*0.716666,7*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([8*0.716666,8*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([9*0.716666,9*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([10*0.716666,10*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([11*0.716666,11*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([12*0.716666,12*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)
plt.loglog([13*0.716666,13*0.716666],[100,10e-10], color='black', linestyle='dashed',linewidth = 0.9)

plt.loglog([16.66666667,16.66666667],[100,10e-10], color='black')
...
plt.ylabel('Power Spectral Density (PSD)', **hfont)
plt.show()
