...
def plot_correction(order: int, threshold:float, pc_env: int, dsf: int):
    ...
    path_scenario_idle = '../VestasV27/03regression_analysis/00outliers_removed/scenario_idle.csv'
    path_scenario_parked = '../VestasV27/03regression_analysis/00outliers_removed/scenario_parked.csv'
    path_scenario_t1 = '../VestasV27/03regression_analysis/00outliers_removed/scenario_t1.csv'
    path_scenario_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/scenario_rpm32.csv'
    path_scenario_t2 = '../VestasV27/03regression_analysis/00outliers_removed/scenario_t2.csv'
    path_scenario_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/scenario_rpm43.csv'
    ...
    path_pca_env_idle = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_idle.csv'
    path_pca_env_parked = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_parked.csv'
    path_pca_env_t1 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_t1.csv'
    path_pca_env_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_rpm32.csv'
    path_pca_env_t2 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_t2.csv'
    path_pca_env_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_rpm43.csv'
    ...
    path_pca_env_train_idle = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_train_idle.csv'
    path_pca_env_train_parked = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_train_parked.csv'
    path_pca_env_train_t1 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_train_t1.csv'
    path_pca_env_train_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_train_rpm32.csv'
    path_pca_env_train_t2 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_train_t2.csv'
    path_pca_env_train_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/pca_env_train_rpm43.csv'
    ...
    path_pca_op_idle = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_idle.csv'
    path_pca_op_parked = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_parked.csv'
    path_pca_op_t1 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_t1.csv'
    path_pca_op_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_rpm32.csv'
    path_pca_op_t2 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_t2.csv'
    path_pca_op_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_rpm43.csv'

    path_pca_op_train_idle = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_train_idle.csv'
    path_pca_op_train_parked = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_train_parked.csv'
    path_pca_op_train_t1 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_train_t1.csv'
    path_pca_op_train_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_train_rpm32.csv'
    path_pca_op_train_t2 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_train_t2.csv'
    path_pca_op_train_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/pca_op_train_rpm43.csv'
    ...
    path_dsf_idle = '../VestasV27/03regression_analysis/00outliers_removed/dsf_idle.csv'
    path_dsf_parked = '../VestasV27/03regression_analysis/00outliers_removed/dsf_parked.csv'
    path_dsf_t1 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_t1.csv'
    path_dsf_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_rpm32.csv'
    path_dsf_t2 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_t2.csv'
    path_dsf_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_rpm43.csv'
    ...
    path_dsf_train_idle = '../VestasV27/03regression_analysis/00outliers_removed/dsf_train_idle.csv'
    path_dsf_train_parked = '../VestasV27/03regression_analysis/00outliers_removed/dsf_train_parked.csv'
    path_dsf_train_t1 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_train_t1.csv'
    path_dsf_train_rpm32 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_train_rpm32.csv'
    path_dsf_train_t2 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_train_t2.csv'
    path_dsf_train_rpm43 = '../VestasV27/03regression_analysis/00outliers_removed/dsf_train_rpm43.csv'
    ...
    path_corrected_dsf_idle = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_idle.csv'
    path_corrected_dsf_parked = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_parked.csv'
    path_corrected_dsf_t1 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_t1.csv'
    path_corrected_dsf_rpm32 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_rpm32.csv'
    path_corrected_dsf_t2 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_t2.csv'
    path_corrected_dsf_rpm43 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_rpm43.csv'
    ...
    path_corrected_dsf_train_idle = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_idle_train.csv'
    path_corrected_dsf_train_parked = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_parked_train.csv'
    path_corrected_dsf_train_t1 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_t1_train.csv'
    path_corrected_dsf_train_rpm32 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_rpm32_train.csv'
    path_corrected_dsf_train_t2 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_t2_train.csv'
    path_corrected_dsf_train_rpm43 = '../VestasV27/03regression_analysis/02correction/poly_order'+str(order)+'/t'+str(threshold)+'/corrected_dsf_rpm43_train.csv'
