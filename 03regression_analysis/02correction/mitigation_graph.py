...
def plot_mitigation(regression_model: str, threshold:float):
    ...
    path_cdsf_idle = "../VestasV27/03regression_analysis/02correction/" + regression_model +'/t'+str(threshold)+ "/corrected_dsf_idle_train.csv"
    path_cdsf_parked = "../VestasV27/03regression_analysis/02correction/" + regression_model +'/t'+str(threshold)+ "/corrected_dsf_parked_train.csv"
    path_cdsf_t1 = "../VestasV27/03regression_analysis/02correction/" + regression_model +'/t'+str(threshold)+ "/corrected_dsf_t1_train.csv"
    path_cdsf_rpm32 = "../VestasV27/03regression_analysis/02correction/" + regression_model +'/t'+str(threshold)+ "/corrected_dsf_rpm32_train.csv"
    path_cdsf_t2 = "../VestasV27/03regression_analysis/02correction/" + regression_model +'/t'+str(threshold)+ "/corrected_dsf_t2_train.csv"
    path_cdsf_rpm43 = "../VestasV27/03regression_analysis/02correction/" + regression_model +'/t'+str(threshold)+ "/corrected_dsf_rpm43_train.csv"

    path_dsf_idle = "../VestasV27/03regression_analysis/00standarized/dsf_train_idle.csv"
    path_dsf_parked = "../VestasV27/03regression_analysis/00standarized/dsf_train_parked.csv"
    path_dsf_t1 = "../VestasV27/03regression_analysis/00standarized/dsf_train_t1.csv"
    path_dsf_rpm32 = "../VestasV27/03regression_analysis/00standarized/dsf_train_rpm32.csv"
    path_dsf_t2 = "../VestasV27/03regression_analysis/00standarized/dsf_train_t2.csv"
    path_dsf_rpm43 = "../VestasV27/03regression_analysis/00standarized/dsf_train_rpm43.csv"

    path_scenario_idle = "../VestasV27/03regression_analysis/00standarized/scenario_train_idle.csv"
    path_scenario_parked = "../VestasV27/03regression_analysis/00standarized/scenario_train_parked.csv"
    path_scenario_t1 = "../VestasV27/03regression_analysis/00standarized/scenario_train_t1.csv"
    path_scenario_rpm32 = "../VestasV27/03regression_analysis/00standarized/scenario_train_rpm32.csv"
    path_scenario_t2 = "../VestasV27/03regression_analysis/00standarized/scenario_train_t2.csv"
    path_scenario_rpm43 = "../VestasV27/03regression_analysis/00standarized/scenario_train_rpm43.csv"
