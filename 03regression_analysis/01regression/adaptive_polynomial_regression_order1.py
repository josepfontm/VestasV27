...
def polynomial_regression(max_order: int, threshold:float, plot_modes:list, plot_regression = False):
    ...
    for r2_mode,dsf_mode,dsf_train_mode,pca_mode,pca_train_mode,file_mode,scenario in zip(r2_modes,dsf_modes,dsf_train_modes,pca_modes,pca_train_modes,file_modes,scenarios):
        ...
        dsf_mode.to_csv('../VestasV27/03regression_analysis/02correction/adaptive_order1'+'/t'+str(threshold)+'/corrected_dsf_'+file_mode+'.csv',sep=';')
        dsf_train_mode.to_csv('../VestasV27/03regression_analysis/02correction/adaptive_order1'+'/t'+str(threshold)+'/corrected_dsf_'+file_mode+'_train.csv',sep=';')
