...
def polynomial_regression(max_order: int, threshold:float, plot_modes:list, plot_regression = False):
    ...
    for r2_mode,dsf_mode,dsf_train_mode,pca_mode,pca_train_mode,file_mode,scenario in zip(r2_modes,dsf_modes,dsf_train_modes,pca_modes,pca_train_modes,file_modes,scenarios):
        ...
        dsf_mode.to_csv('../code_6modes/03regression_analysis/02correction/adaptive_order1'+'/t'+str(threshold)+'/corrected_dsf_'+file_mode+'.csv',sep=';')
        dsf_train_mode.to_csv('../code_6modes/03regression_analysis/02correction/adaptive_order1'+'/t'+str(threshold)+'/corrected_dsf_'+file_mode+'_train.csv',sep=';')
...
#Write command
print('0')
polynomial_regression(max_order=1,threshold=0.0,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.05,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.10,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.15,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.20,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.25,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.30,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.35,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.40,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.45,plot_modes=[])

print('0.5')
polynomial_regression(max_order=1,threshold=0.50,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.55,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.60,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.65,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.70,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.75,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.80,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.85,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.90,plot_modes=[])
polynomial_regression(max_order=1,threshold=0.95,plot_modes=[])
polynomial_regression(max_order=1,threshold=1.00,plot_modes=[])
